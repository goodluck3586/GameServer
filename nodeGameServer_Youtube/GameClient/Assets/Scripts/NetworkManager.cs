...
public class NetworkManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //socket.On("plsyer shoot", OnPlayerShoot);
    ...
    //#region Listening
    //private void OnHealth(SocketIOEvent socketIOEvent)
    //{
    //    throw new NotImplementedException();
    //}

    //private void OnPlayerShoot(SocketIOEvent socketIOEvent)
    //{
    //    throw new NotImplementedException();
    //}
    ...
    //    Transform t = p.transform.Find("Healthbar Cancas");
    ...
    //private void OnEnemies(SocketIOEvent socketIOEvent)
    //{
    //    throw new NotImplementedException();
    //}

    //private void OnOtherPlayerDisconnected(SocketIOEvent socketIOEvent)
    //{
    //    throw new NotImplementedException();
    //}
    //#endregion
